...
export default function QRPage() {
  ...
  const qrCodeValue = searchParams.get("qrCodeValue"); // ← ini wajib dari API attendance

  // Isi QR = URL langsung ke API verifikasi
  ...
  if (!qrCodeValue || !attendanceId) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 to-teal-50 dark:from-gray-900 dark:to-teal-950">
  ...
  return (
    <motion.div
      ...
      className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-green-50 to-teal-50 dark:from-gray-900 dark:to-teal-950">
      <div className="max-w-md w-full bg-white dark:bg-gray-800 rounded-3xl shadow-2xl p-8 text-center">
        ...
        <div className="mb-8 flex justify-center" ref={qrRef}>
          <QRCodeSVG
            value={verifyUrl} // ← sekarang ini URL API
            size={256}
            level="H"
            fgColor="#000000"
            bgColor="#ffffff"

      ...
      <nav
        ...
        <Link href="/" className="group relative perspective-1000">
          <motion.div
            ...
            <motion.div className="absolute -inset-4 bg-gradient-to-r from-blue-600/30 to-cyan-300/30 rounded-full blur-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 animate-pulseGlow" />
          </motion.div>
        </Link>
        ...
        {message.type === "success" && (
          <motion.div
            ...
            <Alert className="bg-gradient-to-br from-green-50 to-emerald-50 border-green-200/50 text-green-800 shadow-3xl backdrop-blur-2xl rounded-2xl">
              ...
              <AlertTitle className="font-extrabold text-base">
                Sukses!
              </AlertTitle>
